...
int main() {
  ...
  printf("So what we see is, that the algorith takes some runtime, which is given as the data and algorithm takes that time to do the job for the given data.\n");
