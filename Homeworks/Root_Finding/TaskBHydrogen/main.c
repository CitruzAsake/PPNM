...
int odedriver(void f(double x, gsl_vector* y, gsl_vector* dydx),double a, gsl_vector* ya, double b, double h,double acc, double eps);

int odedriver2(void f(double x, gsl_vector* y, gsl_vector* dydx),double a, gsl_vector* ya, double **Yal,int steps, double **Xal, double b, double h, double acc, double eps);
...
void ground_state(gsl_vector* eps, gsl_vector* fx)
{
    ...
    odedriver(schrodinger_eq,a,ya,R_max,0.1,acc,rel_acc);
...
int main()
{
    ...
    odedriver2(schrodinger_eq,a,ya,&Yal,m,&Xal,b,(b-a)/10,abs,eps);
